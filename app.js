...
console.log(jupiterMoons);
    ...
    // 7. Change Uranus' moon "Umbriel" to "Oberon"
     solarSystem.forEach(planet => {
         if (planet.name === "Uranus") {
          const moonIndex = planet.moons.indexOf("Umbriel");
          if (moonIndex !== -1) {
           planet.moons[moonIndex] = "Oberon";
         }
        }
     });
 ...
 period: 164.79,
    ...
    const totalSatellites = system.jupiter.satellites + system.uranus.satellites + system.neptune.satellites;
    ...
    const plutomomentum = sytem.pluto.velocity * system.pluto.mass;
    const momentumDifference = jupiterMomentum - plutomomentum;
    console.log(momentumDiffference); 